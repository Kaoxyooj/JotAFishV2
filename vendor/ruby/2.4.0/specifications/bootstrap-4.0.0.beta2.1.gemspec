# -*- encoding: utf-8 -*-
# stub: bootstrap 4.0.0.beta2.1 ruby lib

Gem::Specification.new do |s|
  s.name = "bootstrap".freeze
  s.version = "4.0.0.beta2.1"
  ...
  s.installed_by_version = "2.7.1" if s.respond_to? :installed_by_version

  if s.respond_to? :specification_version then
    s.specification_version = 4

    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<popper_js>.freeze, ["< 2", ">= 1.12.3"])
      ...
      s.add_dependency(%q<popper_js>.freeze, ["< 2", ">= 1.12.3"])
